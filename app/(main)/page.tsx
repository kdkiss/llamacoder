    ...
    <div className="relative flex grow flex-col">
      ...
      <div className="isolate flex h-full grow flex-col">
        ...
        <div className="mt-10 flex grow flex-col items-center px-4 lg:mt-16">
          <a
            className="mb-4 inline-flex shrink-0 items-center rounded-full border-[0.5px] bg-white px-7 py-2 text-xs text-gray-800 shadow-[0px_1px_1px_0px_rgba(0,0,0,0.25)] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 md:text-base"
          ...
          <h1 className="mt-4 text-balance text-center text-4xl leading-none text-gray-700 dark:text-gray-200 md:text-[64px] lg:mt-8">
          ...
          >
            <Fieldset>
              <div className="relative flex w-full max-w-2xl rounded-xl border-4 border-gray-300 bg-white pb-10 dark:border-gray-700 dark:bg-gray-800">
                <div className="w-full">
                  {screenshotLoading && (
                    <div className="relative mx-3 mt-3">
                      <div className="rounded-xl">
                        <div className="group mb-2 flex h-16 w-[68px] animate-pulse items-center justify-center rounded bg-gray-200 dark:bg-gray-700">
                          <Spinner />
                        </div>
                      </div>
                    </div>
                  ...
                  {screenshotUrl && (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        id="x-circle-icon"
                        className="absolute -right-3 -top-4 left-14 z-10 size-5 rounded-full bg-white text-gray-900 hover:text-gray-500 dark:bg-gray-800 dark:text-gray-100"
                        onClick={() => {
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      name="prompt"
                      rows={1}
                      className="peer absolute inset-0 w-full resize-none bg-transparent p-3 placeholder-gray-500 focus-visible:outline-none disabled:opacity-50 dark:text-gray-100 dark:placeholder-gray-400"
                      value={prompt}
                ...
                <div className="absolute bottom-2 left-2 right-2.5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Select.Trigger className="inline-flex items-center gap-1 rounded-md p-1 text-sm text-gray-400 hover:bg-gray-100 hover:text-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-300 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                      ...
                      <Select.Portal>
                        <Select.Content className="overflow-hidden rounded-md bg-white shadow ring-1 ring-black/5 dark:bg-gray-800 dark:ring-white/10">
                          <Select.Viewport className="space-y-1 p-2">
                            {availableModels.map((m) => (
                              <Select.Item
                                key={m.value}
                                value={m.value}
                                className="flex cursor-pointer items-center gap-1 rounded-md p-1 text-sm data-[highlighted]:bg-gray-100 data-[highlighted]:outline-none dark:data-[highlighted]:bg-gray-700"
                              >
                    ...
                    <div className="h-4 w-px bg-gray-200 max-sm:hidden dark:bg-gray-700" />
                    ...
                    >
                      <Select.Trigger className="inline-flex items-center gap-1 rounded p-1 text-sm text-gray-400 hover:bg-gray-100 hover:text-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-300 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                    ...
                    <div>
                      ...
                      >
                        <div className="flex size-6 items-center justify-center rounded bg-black hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600">
        ...
        <footer className="flex w-full flex-col items-center justify-between space-y-3 px-5 pb-3 pt-5 text-center sm:flex-row sm:pt-2">
          <div>
            <div className="font-medium text-gray-700 dark:text-gray-300">
              ...
              <a
                href="https://togetherai.link/?utm_source=llamacoder&utm_medium=referral&utm_campaign=example-app"
                className="font-semibold text-blue-600 underline-offset-4 transition hover:text-gray-700 hover:underline dark:text-blue-400 dark:hover:text-gray-300"
              >
                Llama
              </a>{" "}
              and{" "}
          ...
          <div className="flex space-x-4 pb-4 sm:pb-0">
            ...
            >
              <svg
                aria-hidden="true"
                className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
              >
...
function LoadingMessage({
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-white px-1 py-3 md:px-3 dark:bg-gray-800">
