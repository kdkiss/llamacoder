  ...
  return (
    <form action={shareAction} className="flex">
      <button
        type="submit"
        disabled={!message}
        className="inline-flex items-center gap-1 rounded border border-border px-1.5 py-0.5 text-sm text-muted-foreground enabled:hover:bg-background disabled:opacity-50"
      >
