  ...
  return (
    <>
      {isMobile ? (
        ...
        >
          <div className="ml-4 flex h-full flex-col rounded-l-xl shadow-lg shadow-gray-400/40 dark:shadow-gray-900/60">
            <div className="flex h-full flex-col rounded-l-xl shadow shadow-gray-800/50 dark:shadow-black/50">
              {children}
            </div>
          </div>
        </div>
